...
// The "Apple-style" clean input design
const inputStyle = {
        ...
        <Paper elevation={0} sx={{
          ...
          <Box component="form" noValidate sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
            ...
            <Box>
                ...
                <TextField fullWidth name="password" type="password" id="password" placeholder="Enter your password" sx={inputStyle} />
            </Box>
            ...
            <Button
              ...
              sx={{
                mt: 2,
                py: 1.8,
                borderRadius: '980px', // Pill shape button
                fontSize: '1.05rem',
                fontWeight: '600',
                textTransform: 'none', 
                backgroundColor: '#0071e3', // Premium Blue
                boxShadow: 'none',
            ...
            <Box textAlign="center" mt={3}>
               <Typography variant="body2" color="#86868b">
                  ...
                  <Link to="/register" style={{ textDecoration: 'none', color: '#0071e3', fontWeight: '500' }}>
                    Sign up
                  </Link>
               </Typography>
            </Box>
